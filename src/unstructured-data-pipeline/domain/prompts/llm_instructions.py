...
template = ChatPromptTemplate.from_messages([
    SystemMessage(
        ...
        "If the database file does not exist, use the provided database creation tool to create it first. "
        "After generating SQL statements, use the provided execution tool to run them on the database. "
        "Using the content from multiple input files, create database tables with column names exactly as defined in {main_schema}. "
